...
const HawaiiSection = () => {
  return <div className='hawaiisection'>
    ...
    <div className="hawaii-container">
      <h3 className="hawaii-h3">Hawaii Whitelist = Hawaii Premier Event</h3>

      <button className="hawaii-btn">Whitelist</button>

      <p className="hawaii-p">First <strong>100 whitelist</strong>, must buy <strong>100 nodes @ $0.00001</strong>. NFT lottery for an additional <strong>100 spots</strong> to come <strong>soon</strong>.</p>
      ...
      <p className="hawaii-p"><strong>Incredible all-inclusive experience on the Kaanapali Beach<br></br>Location subject to change</strong></p>
